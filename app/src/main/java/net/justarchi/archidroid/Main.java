...
public final class Main extends Activity implements ActionBar.TabListener {
	...
	*/
	...
	@Override
	public final void onTabSelected(final ActionBar.Tab tab, final FragmentTransaction fragmentTransaction) {
	...
	@Override
	public final void onTabUnselected(final ActionBar.Tab tab, final FragmentTransaction ft) {

	}

	@Override
	public final void onTabReselected(final ActionBar.Tab tab, final FragmentTransaction ft) {
